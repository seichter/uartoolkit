...
/** HSE25: runtime config needed here */
#define   DEFAULT_FITTING_MODE        AR_FITTING_TO_INPUT /* AR_FITTING_TO_IDEAL */
#define   DEFAULT_IMAGE_PROC_MODE     AR_IMAGE_PROC_IN_FULL /* AR_IMAGE_PROC_IN_HALF*/
